...
## Project Structure
    ...
    ├── testapiautostorybo_125750  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_125750`
...
2. Clone this repo and `cd testapiautostorybo_125750`
